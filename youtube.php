<?php
    ...
    $search_count = 0;
    $search_items = array();
    $search_q = "Stock Technical Analysis";
    $search_maxResults = "24";
    $search_sub_string = "";
    $arrSubCategories = array(array("Live", "Live"), array("Commoditties", "Commoditties Technical analysis"), array("Marijuana", "Marijuana Technical analysis"), array("FANG", "AAPL OR GOOGL OR NFLX OR FB AND Technical analysis"), array("Indexes", "Indexes Technical analysis"), array("ETFs", "ETFs Technical analysis"), array("Earnings", "Earnings Technical analysis"), array("News", "News Technical analysis"));
    $sub_index = -1;
